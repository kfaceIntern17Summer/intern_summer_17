                ...
                <div class="box-body">
                    <div class="table-responsive">
                        ...
                        <div class="form-group">
                            ...
                            <select name="date" class="form-control col-md-2 col-xs-4">
                                <%
                                    for (Map<String, Object> report : reportData) {

                                %>
                                <option value="<%=report.get("date")%>"><%=report.get("date")%>
                                </option>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row" style="padding-bottom: 10px;">
                                    <label class="col-md-4">
                                        <p><%=member.get("member_name")%>
                                        </p>
                                    </label>
                                    <%
                                        try{
                                        if ((Integer)member.get("attendance")==1) {
                                    %>
                                    <label class="radio-inline2 col-md-2"><input type="radio" name="optradio"
                                                                                 checked="checked">출석</label>
                                    <%
                                    } else {
                                    %>
                                    <label class="radio-inline2 col-md-2"><input type="radio" name="optradio"
                                                                                 checked="checked">결석</label>
                                    <%
                                        }
                                    ...
                                    <%--<label class="radio-inline2 col-md-2"><input type="radio" name="optradio"--%>
                                    <%--checked="checked">출석</label>--%>
                                    <%--<label class="radio-inline2 col-md-2"><input type="radio" name="optradio">결석</label>--%>
                                </div>
                        ...
                        <%--<div class="row" style="padding-bottom: 10px;">--%>
                        <%--<label class="col-md-4">--%>
                        <%--<p><%=((CellInfo) map.get(mapkey)).member%>--%>
                        <%--</p>--%>
                        <%--</label>--%>
                        <%--<div class="col-md-8">--%>
